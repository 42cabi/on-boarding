...
public enum ExceptionStatus {
	...
	INVALID_ACCESS(HttpStatus.BAD_REQUEST, "잘못된 접근입니다.", "005"),
	INVALID_FORMAT_MESSAGE(HttpStatus.BAD_REQUEST, "잘못된 형식의 메세지입니다!", "007"),
	NOT_FOUND_USER(HttpStatus.NOT_FOUND, "존재하지 않는 유저입니다.", "008"),
	INVALID_QUERY_PARAMETER(HttpStatus.BAD_REQUEST, "잘못된 쿼리스트링 입니다.", "009"),
